...
def move_mouse(axis, value):
    """Envia para o jogo o comando dependendo do sinal recebido

    Axis:
    * 01 - Abre o inventário (TAB)
    * 02 - Move a seleção para cima (W)
    * 03 - Move a seleção para baixo (S)
    * 04 - Move a seleção para a direita (D)
    * 05 - Move a seleção para a esquerda (A)
